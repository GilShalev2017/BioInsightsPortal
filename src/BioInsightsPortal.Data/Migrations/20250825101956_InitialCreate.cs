        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Chromosome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Associations_Diseases_DiseaseId",
                        column: x => x.DiseaseId,
                        principalTable: "Diseases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Associations_Genes_GeneId",
                        column: x => x.GeneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TargetGeneId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drugs_Genes_TargetGeneId",
                        column: x => x.TargetGeneId,
                        principalTable: "Genes",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Associations_DiseaseId",
                table: "Associations",
                column: "DiseaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Associations_GeneId",
                table: "Associations",
                column: "GeneId");

            migrationBuilder.CreateIndex(
                name: "IX_Drugs_TargetGeneId",
                table: "Drugs",
                column: "TargetGeneId");
        }
